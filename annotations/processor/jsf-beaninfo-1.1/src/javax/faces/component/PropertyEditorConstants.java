...
class PropertyEditorConstants {
    ...
    static final String CONVERTER_EDITOR = "com.sun.rave.propertyeditors.ConverterPropertyEditor";
    
    static final String METHODBINDING_EDITOR = "com.sun.rave.propertyeditors.MethodBindingPropertyEditor";
    
    static final String STRING_EDITOR = "com.sun.rave.propertyeditors.StringPropertyEditor";
    
    static final String STYLECLASS_EDITOR = "com.sun.rave.propertyeditors.StyleClassPropertyEditor";
