        ...
        <webuijsf:form id="accordionExample">
          ...
          <table><tr valign="top">
            ...
            <td style="width:500px">
              ...
              <div style="width:30%">
                Accordion occupying 30% of parent width with standard tab content 
                height = 100px and a saved view selector set at a fixed height = 100%.
                Multiple select is set to true.
              </div>
            ...
            <td style="width:200px">
              ...
              <div style="width:100%">
                Accordion occupying 100% of parent width with standard tab content 
                height = 100px and a saved view selector that fits all items. 
                Multiple select set to false.
              </div>
