  ...
  <f:view>
    ...
    <webuijsf:page >
      <webuijsf:html>
        ...
        <webuijsf:head title="#{msgs.table_selectMultipleRowsTitle}">
          ...
          <webuijsf:form id="form1">
            ...
            <webuijsf:breadcrumbs id="breadcrumbs">
              ...
              <webuijsf:hyperlink actionExpression="#{TableBean.showTableIndex}" text="#{msgs.table_title}"
                ...
                onMouseOut="javascript: window.status=''; return true" />
              <webuijsf:hyperlink text="#{msgs.table_selectMultipleRowsTitle}"/>
            </webuijsf:breadcrumbs>
  
            <webuijsf:contentPageTitle title="#{msgs.table_selectMultipleRowsTitle}"/>
            <webuijsf:markup tag="div" styleClass="#{themeStyles.CONTENT_MARGIN}">
              ...
              <br/>
              <webuijsf:staticText text="#{msgs.table_selectMultipleRowsConcepts1}"/>
  
              <br/><br/>
              <webuijsf:staticText text="#{msgs.table_selectMultipleRowsConcepts2}"/>
