  ...
  <f:view>
    ...
    <webuijsf:page >
      <webuijsf:html>
        ...
        <webuijsf:head title="#{msgs.table_customTitle}">
          ...
          <webuijsf:form id="form1">
            ...
            <webuijsf:breadcrumbs id="breadcrumbs">
              ...
              <webuijsf:hyperlink actionExpression="#{TableBean.showTableIndex}" text="#{msgs.table_title}"
                ...
                onMouseOut="javascript: window.status=''; return true" />
              <webuijsf:hyperlink text="#{msgs.table_customTitle}"/>
            </webuijsf:breadcrumbs>

            <webuijsf:contentPageTitle title="#{msgs.table_customTitle}"/>
            <webuijsf:markup tag="div" styleClass="#{themeStyles.CONTENT_MARGIN}">
              ...
              <webuijsf:table id="table1">
                ...
                <!-- Title -->
                <f:facet name="title">
                  <webuijsf:staticText text="#{msgs.table_customTitle}"/>
                </f:facet>
              </webuijsf:table>

              <br/>
              <webuijsf:staticText text="#{msgs.table_customConcepts}"/>
