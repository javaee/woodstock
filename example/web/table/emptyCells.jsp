  ...
  <f:view>
    ...
    <webuijsf:page >
      <webuijsf:html>
        ...
        <webuijsf:head title="#{msgs.table_emptyCellsTitle}">
          ...
          <webuijsf:form id="form1">
            ...
            <webuijsf:breadcrumbs id="breadcrumbs">
              ...
              <webuijsf:hyperlink actionExpression="#{TableBean.showTableIndex}" text="#{msgs.table_title}"
                ...
                onMouseOut="javascript: window.status=''; return true" />
              <webuijsf:hyperlink text="#{msgs.table_emptyCellsTitle}"/>
            </webuijsf:breadcrumbs>
            
            <webuijsf:contentPageTitle title="#{msgs.table_emptyCellsTitle}"/>
            <webuijsf:markup tag="div" styleClass="#{themeStyles.CONTENT_MARGIN}">
              ...
              <br/>
                ...
                <!-- Empty Cells -->
                <webuijsf:table id="table1" title="#{msgs.table_emptyCellsTitle}">
              ...
              <br/>
              <webuijsf:staticText text="#{msgs.table_embeddedActionsConcepts1}"/>
  
              <br/>
              <br/>
              <webuijsf:staticText text="#{msgs.table_embeddedActionsConcepts2}"/>
