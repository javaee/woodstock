  ...
  <f:view>
    ...
    <webuijsf:page >
      <webuijsf:html>
        ...
        <webuijsf:head title="#{msgs.table_spacerColumnTitle}" >
          ...
          <webuijsf:form id="form1">
            ...
            <webuijsf:breadcrumbs id="breadcrumbs">
              ...
              <webuijsf:hyperlink actionExpression="#{TableBean.showTableIndex}" text="#{msgs.table_title}"
                ...
                onMouseOut="javascript: window.status=''; return true" />
              <webuijsf:hyperlink text="#{msgs.table_spacerColumnTitle}"/>
            </webuijsf:breadcrumbs>
  
            <webuijsf:contentPageTitle title="#{msgs.table_spacerColumnTitle}"/>
            <webuijsf:markup tag="div" styleClass="#{themeStyles.CONTENT_MARGIN}">
              ...
              <!-- Spacer Column -->
              <webuijsf:table id="table1" title="#{msgs.table_spacerColumnTitle}">
              ...
              <br/>
              <webuijsf:staticText text="#{msgs.table_spacerColumnConcepts}"/>
