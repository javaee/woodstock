    ...
    <webuijsf:page >
      <webuijsf:html>
          ...
          <webuijsf:form id="form1">
            ...
            <webuijsf:breadcrumbs id="breadcrumbs">
              ...
              <webuijsf:hyperlink actionExpression="#{Table2Bean.showTableIndex}" text="#{msgs.table_title}"
                ...
                onMouseOut="javascript: window.status=''; return true" />
              <webuijsf:hyperlink text="#{msgs.table2_basicTitleSort}"/>
            </webuijsf:breadcrumbs>

           <webuijsf:contentPageTitle title="#{msgs.table2_basicTitleSort}"/>
        ...
        <webuijsf:table2 id="table1"
                title="#{msgs.table2_basicTitleSort}">
        ...
        <br/>
              <webuijsf:staticText text="#{msgs.table2_sortDetails}"/>
        </webuijsf:markup>
      </webuijsf:form>
    </webuijsf:body>
    </webuijsf:html>
