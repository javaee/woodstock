          ...
          <webuijsf:form id="form1">
            ...
            <webuijsf:breadcrumbs id="breadcrumbs">
              ...
              <webuijsf:hyperlink actionExpression="#{Table2Bean.showTableIndex}" text="#{msgs.table_title}"
                ...
                onMouseOut="javascript: window.status=''; return true" />
              <webuijsf:hyperlink text="#{msgs.table2_basicTitleSpanHeader}"/>
            </webuijsf:breadcrumbs>

           <webuijsf:contentPageTitle title="#{msgs.table2_basicTitleSpanHeader}"/>
              ...
              <webuijsf:table2RowGroup id="rowGroup1"
                  ...
                  headerText="#{msgs.table_detail}">
                        <webuijsf:table2Column id="col0"        
                            headerText="#{msgs.table2_colHeader1}" footerText="#{msgs.table2_colFooter1}">
                          <webuijsf:staticText text="#{msgs.table2_colItem}#{name.tableRow.rowId + 1}"/>
                        </webuijsf:table2Column>
                        <webuijsf:table2Column id="col1" headerText="#{msgs.table2_colHeader2}">
                            <webuijsf:table2Column id="col_0"
                                 sort="last" footerText="#{msgs.table2_colFooter2}"
                                headerText="#{msgs.table2_colHeader3}">
                              <webuijsf:staticText text="#{name.value.last}"/>
                        </webuijsf:table2Column>
                        <webuijsf:table2Column id="col_1_1"             
                                    headerText="#{msgs.table2_colHeader4}">
                                <webuijsf:table2Column id="col_1_1_0"                     
                                    headerText="#{msgs.table2_colHeader5}" footerText="#{msgs.table2_colFooter3}">  
                                    <webuijsf:staticText text="#{msgs.table2_colTextItem}#{name.tableRow.rowId + 1}"/>
                                </webuijsf:table2Column>
                                <webuijsf:table2Column id="col_1_1_1"
                                     sort="first" footerText="#{msgs.table2_colFooter4}"
                                    headerText="#{msgs.table2_colHeader6}">  
