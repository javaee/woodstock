...
<jsp:root version="2.0"
  ...
  <f:view>
    <webuijsf:page id="thepage">
      ...
      <webuijsf:html>
	<webuijsf:head id="head" title="#{msgs.tree2_example7}" debug="true" webuiAll="true" />
	  ...
	  <webuijsf:form id="myForm">
	   <webuijsf:masthead id="masthead"
            ...
            <webuijsf:breadcrumbs id="breadcrumbs">
              ...
              <webuijsf:hyperlink url="../tree2/example3.jsp" text="#{msgs.tree2_example7}"/>
            </webuijsf:breadcrumbs>
	    
	    <!-- PageTitle... -->
	    <webuijsf:contentPageTitle id="pageTitle" title="#{msgs.index_title}" 
                helpText="#{msgs.tree2_example7_help}" />
	    ...
	    <!-- End Tree Example 1 -->
            ...
            <webuijsf:hyperlink tabIndex="1">Tabbed Link</webuijsf:hyperlink>
            <br/>
            <p> This example shows how the tree can be navigated using keystrokes.
            Once you tab out from a node inside the tree, the same node will be
            selected when you tab back into the tree. Within the tree left and right
            arrow keys should be used to navigate from one node to another. The space 
            bar should be used to expand/collapse nodes. </p>
