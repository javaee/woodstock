...
<jsp:root version="2.0"
  ...
  <f:view>
    <webuijsf:page id="thepage">
      ...
      <webuijsf:html>
	<webuijsf:head id="head" title="#{msgs.tree2_example5}"
    ...
    <webuijsf:script>
            function init() {
                ...
                domNode.subscribe(woodstock4_3.widget.tree.event.nodeSelection.endTopic,handleSelectedEvent); 
            }
	  ...
	  <webuijsf:form id="myForm">
	    <webuijsf:masthead id="masthead"
            ...
            <webuijsf:breadcrumbs id="breadcrumbs">
              ...
              <webuijsf:hyperlink url="../tree2/example3.jsp" text="#{msgs.tree2_example5}"/>
            </webuijsf:breadcrumbs>
	    
	    <!-- PageTitle... -->
	    <webuijsf:contentPageTitle id="pageTitle" title="#{msgs.index_title}" 
                helpText="#{msgs.tree2_example5_help}" />
            <webuijsf:markup tag="div" styleClass="#{themeStyles.CONTENT_MARGIN}">
            
            
            <webuijsf:tree2 id="tree" binding="#{TestTreeBean.dynamicTree}">
            </webuijsf:tree2>	
