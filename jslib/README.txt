...
This module builds the Woodstock JavaScript library. Currently, there
are 2 ways to build the module:
...
Note: This build depends on the theme module, which must be built
first.
