 ...
 * @private
 */
webui.@THEME_JS@._base.body = function(viewId, path, defaultFocusElementId, 
	...
	this.scrollCookie = new webui.@THEME_JS@._base.scrollCookie(viewId, path);
    }
	...
	//
        if (webui.@THEME_JS@.browser.isIe()) {
            webui.@THEME_JS@._base.dojo.connect(document, "onfocusin", this, "focusListener");
        } else {
            webui.@THEME_JS@._base.dojo.connect(window, "onfocus", this, "focusListener");
        }
	...
	*/
    ...
    if (this.preserveScroll == true) {
        webui.@THEME_JS@._base.dojo.addOnUnload(this, "onUnloadListener");
    }
};
