...
(function(){
	...
	webui.@THEME_JS@._dojo.locale = webui_@THEME_JS@.djConfig.locale;
...
//		}
		...
		d._xhrObj= function(){
			...
			var http = null;
			var last_e = null;
			if(!webui.@THEME_JS@._dojo.isIE || !webui_@THEME_JS@.djConfig.ieForceActiveXXhr){
	...
	if(document.addEventListener){
		...
		if(webui.@THEME_JS@._dojo.isOpera|| (webui.@THEME_JS@._dojo.isMoz && (webui_@THEME_JS@.djConfig["enableMozDomContentLoaded"] === true))){
...
// webui.@THEME_JS@._dojo.requireIf((webui_@THEME_JS@.djConfig["isDebug"] || webui_@THEME_JS@.djConfig["debugAtAllCosts"]), "webui.@THEME_JS@._dojo.debug");
...
// webui.@THEME_JS@._dojo.requireIf(webui_@THEME_JS@.djConfig["debugAtAllCosts"] && !window.widget && !webui_@THEME_JS@.djConfig["useXDomain"], "webui.@THEME_JS@._dojo.browser_debug");
// webui.@THEME_JS@._dojo.requireIf(webui_@THEME_JS@.djConfig["debugAtAllCosts"] && !window.widget && webui_@THEME_JS@.djConfig["useXDomain"], "webui.@THEME_JS@._dojo.browser_debug_xd");
...
(function(){
	if(webui_@THEME_JS@.djConfig.require){
		for(var x=0; x<webui_@THEME_JS@.djConfig.require.length; x++){
			webui.@THEME_JS@._dojo["require"](webui_@THEME_JS@.djConfig.require[x]);
		}
	}
})();
