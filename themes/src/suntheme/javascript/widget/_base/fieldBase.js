...
webui.@THEME_JS@._base.dojo.provide("webui.@THEME_JS@.widget._base.fieldBase");
 ...
 * @constructor
 */
webui.@THEME_JS@._base.dojo.declare("webui.@THEME_JS@.widget._base.fieldBase",
 ...
 * @return {Object} an object with the <code>htmlFor</code> property set.
 * @private
 */
webui.@THEME_JS@.widget._base.fieldBase.prototype._getLabelProps = function(props) {
