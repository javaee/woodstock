...
webui.@THEME_JS@._base.dojo.provide("webui.@THEME_JS@.widget._jsfx.calendar");
...
webui.@THEME_JS@._base.dojo.subscribe(webui.@THEME_JS@.widget.calendar.event.refresh.beginTopic,
