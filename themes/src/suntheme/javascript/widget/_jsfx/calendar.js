...
webui.@THEME_JS@._dojo.provide("webui.@THEME_JS@.widget._jsfx.calendar");
...
webui.@THEME_JS@._dojo.subscribe(webui.@THEME_JS@.widget.calendar.event.refresh.beginTopic,
