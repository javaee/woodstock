...
webui.@THEME_JS@._base.dojo.provide("webui.@THEME_JS@.widget._jsfx.button");
...
webui.@THEME_JS@._base.dojo.subscribe(webui.@THEME_JS@.widget.button.event.refresh.beginTopic,
