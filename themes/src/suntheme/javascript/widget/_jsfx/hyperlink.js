...
webui.@THEME_JS@._base.dojo.provide("webui.@THEME_JS@.widget._jsfx.hyperlink");
...
webui.@THEME_JS@._base.dojo.subscribe(webui.@THEME_JS@.widget.hyperlink.event.refresh.beginTopic,
