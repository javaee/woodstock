...
webui.@THEME_JS@._dojo.provide("webui.@THEME_JS@.widget._jsfx.hyperlink");
...
webui.@THEME_JS@._dojo.subscribe(webui.@THEME_JS@.widget.hyperlink.event.refresh.beginTopic,
