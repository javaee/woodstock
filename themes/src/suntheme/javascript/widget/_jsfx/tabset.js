...
@JS_NS@._dojo.provide("@JS_NS@.widget._jsfx.tabset");

@JS_NS@._dojo.require("@JS_NS@.widget._jsfx.common");
@JS_NS@._dojo.require("@JS_NS@.widget.tabset");
...
@JS_NS@._dojo.subscribe(@JS_NS@.widget.tabset.event.refresh.beginTopic,
