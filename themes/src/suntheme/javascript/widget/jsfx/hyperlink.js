...
webui.@THEME_JS@.dojo.provide("webui.@THEME_JS@.widget.jsfx.hyperlink");
...
webui.@THEME_JS@.dojo.subscribe(webui.@THEME_JS@.widget.hyperlink.event.refresh.beginTopic,
