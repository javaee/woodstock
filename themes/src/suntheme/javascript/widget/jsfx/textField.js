...
webui.@THEME_JS@.dojo.provide("webui.@THEME_JS@.widget.jsfx.textField");
 ...
 * @static
 */
webui.@THEME_JS@.widget.jsfx.textField = {
    /**
    ...
    processValidationEvent: function(props) {
        ...
        DynaFaces.fireAjaxTransaction(
            ...
            execute: props.id,
            render: props.id,
            replaceElement: webui.@THEME_JS@.widget.jsfx.textField.validationCallback,
            xjson: {
                id : props.id,
                event: "validate"
            }
    ...
    validationCallback: function(elementId, content, closure, xjson) {
        ...
        if (widget.notify) {
            ...
            for (var i = 0; i < widget.notify.length; i++) {
                ...
                var curWidget = webui.@THEME_JS@.dijit.byId(widget.notify[i]);
    ...
    processAutoCompleteEvent: function(props) {
        ...
        DynaFaces.fireAjaxTransaction(
            ...
            execute: props.id,
            render: props.id,
            replaceElement: webui.@THEME_JS@.widget.jsfx.textField.autoCompleteCallback,
            xjson: {
                id : props.id,
                event: "autocomplete"
            }
...
webui.@THEME_JS@.dojo.subscribe(webui.@THEME_JS@.widget.textField.event.refresh.beginTopic,
    webui.@THEME_JS@.widget.jsfx.common, "processRefreshEvent");
webui.@THEME_JS@.dojo.subscribe(webui.@THEME_JS@.widget.textField.event.state.beginTopic,
    webui.@THEME_JS@.widget.jsfx.common, "processStateEvent");
webui.@THEME_JS@.dojo.subscribe(webui.@THEME_JS@.widget.textField.event.submit.beginTopic,
    webui.@THEME_JS@.widget.jsfx.common, "processSubmitEvent");
webui.@THEME_JS@.dojo.subscribe(webui.@THEME_JS@.widget.textField.event.validation.beginTopic,
    webui.@THEME_JS@.widget.jsfx.textField, "processValidationEvent");
webui.@THEME_JS@.dojo.subscribe(webui.@THEME_JS@.widget.textField.event.autoComplete.beginTopic,
    webui.@THEME_JS@.widget.jsfx.textField, "processAutoCompleteEvent");
