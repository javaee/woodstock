Added the Rhino compress tool, used by Dojo, to our own build. It
...
To build the compress.jar, run the build.sh script in this
directory. To run the compress program, use:

    java -jar compress.jar -rhinoJar custom_rhino.jar -pathName <path> -verbose
