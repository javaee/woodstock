...
dojo.provide("webui.@THEME@.widget.jsfx.alarm");

dojo.require("webui.@THEME@.widget.alarm");

/**
 * This function is used to obtain data asynchronously.
 */
webui.@THEME@.widget.jsfx.alarm = {
    /**
    ...
    processRefreshEvent: function(props) {
        ...
        DynaFaces.fireAjaxTransaction(
            ...
            render: props.id,
            replaceElement: webui.@THEME@.widget.jsfx.alarm.refreshCallback,
            xjson: {
                id: props.id,
                event: "refresh"
            }
    ...
    refreshCallback: function(id, content, closure, xjson) {
        ...
        dojo.event.topic.publish(
            webui.@THEME@.widget.alarm.refresh.endEventTopic, props);
        return true;
    }
}

// Listen for Dojo Widget events.
dojo.event.topic.subscribe(webui.@THEME@.widget.alarm.refresh.beginEventTopic,
    webui.@THEME@.widget.jsfx.alarm, "processRefreshEvent");
