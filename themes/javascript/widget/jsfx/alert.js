 ...
 webui.@THEME@.widget.jsfx.alert = {
     ...
     processRefreshEvent: function(props) {
         ...
         new DynaFaces.fireAjaxTransaction(
             ...
             render: props.id,
             replaceElement: webui.@THEME@.widget.jsfx.alert.refreshCallback,
             xjson: {
                 id: props.id,
                 event: "refresh"
             }
     ...
     refreshCallback: function(id, content, closure, xjson) {
        ...
        // Publish an event for custom AJAX implementations to listen for.
         webui.@THEME@.widget.alert.refresh.publishEndEvent(json);
         return true;
    }
 }
 
 // Listen for Dojo Widget events.
 dojo.event.topic.subscribe(webui.@THEME@.widget.alert.refresh.beginEventTopic,
     webui.@THEME@.widget.jsfx.alert, "processRefreshEvent");
