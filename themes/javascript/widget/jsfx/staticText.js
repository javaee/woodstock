 ...
 */
webui.@THEME@.widget.jsfx.staticText = {
    /**
    ...
    processRefreshEvent: function(props) {
        ...
        new DynaFaces.fireAjaxTransaction(
            ...
            render: props.id,
            replaceElement: webui.@THEME@.widget.jsfx.staticText.refreshCallback,
            xjson: {
                id: props.id,
                event: "refresh"
            }
    ...
    refreshCallback: function(id, content, closure, xjson) {
        ...
        webui.@THEME@.widget.staticText.refresh.publishEndEvent(json);
        return true;
    }
}

// Listen for Dojo Widget events.
dojo.event.topic.subscribe(webui.@THEME@.widget.staticText.refresh.beginEventTopic,
    webui.@THEME@.widget.jsfx.staticText, "processRefreshEvent");
