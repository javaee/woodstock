  ...
  */
 webui.@THEME@.widget.jsfx.rbcbGroup = {
     /**
     ...
     processRefreshEvent: function(props) {
         ...
         new DynaFaces.fireAjaxTransaction(
             ...
             render: props.id,
             replaceElement: webui.@THEME@.widget.jsfx.rbcbGroup.refreshCallback,
             xjson: {
                 id: props.id,
                 event: "refresh"
             }
     ...
     refreshCallback: function(id, content, closure, xjson) {
        ...
        // Publish an event for custom AJAX implementations to listen for.
         webui.@THEME@.widget.rbcbGroup.refresh.publishEndEvent(json);
         return true;
    }
 }
 ...
 dojo.event.topic.subscribe(webui.@THEME@.widget.rbcbGroup.refresh.beginEventTopic,
     webui.@THEME@.widget.jsfx.rbcbGroup, "processRefreshEvent");
