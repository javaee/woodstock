...
dojo.provide("webui.@THEME@.widget.jsfx.hyperlink");
 ...
 */
webui.@THEME@.widget.jsfx.hyperlink = {
    /**
    ...
    processRefreshEvent: function(props) {
        ...
        new DynaFaces.fireAjaxTransaction(
            ...
            render: props.id,
            replaceElement: webui.@THEME@.widget.jsfx.hyperlink.refreshCallback,
            xjson: {
                id: props.id,
                event: "refresh"
            }
...
dojo.event.topic.subscribe(webui.@THEME@.widget.hyperlink.refresh.beginEventTopic,
    webui.@THEME@.widget.jsfx.hyperlink, "processRefreshEvent");
