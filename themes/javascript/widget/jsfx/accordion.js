 ...
 */
webui.@THEME@.widget.jsfx.accordion = {
    ...
    processRefreshEvent: function(props) {
        ...
        DynaFaces.fireAjaxTransaction(
            ...
            render: props.id,
            replaceElement: webui.@THEME@.widget.jsfx.accordion.refreshCallback,
            xjson: {
                id: props.id,
                event: "refresh"
            }
    ...
    /**
     * This function is used to refresh the accordion widget once the 
     * XHR call returns with the updated data.
     *
    ...
    refreshCallback: function(id, content, closure, xjson) {
        ...
        // webui.@THEME@.widget.accordion.refresh.publishEndEvent(json);
        dojo.event.topic.publish(webui.@THEME@.widget.accordion.refresh.endEventTopic, 
            json);
        return true;
    }
...
dojo.event.topic.subscribe(webui.@THEME@.widget.accordion.refresh.beginEventTopic,
    webui.@THEME@.widget.jsfx.accordion, "processRefreshEvent");
