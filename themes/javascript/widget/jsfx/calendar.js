 ...
 */
webui.@THEME@.widget.jsfx.calendar = {
    /**
    ...
    processRefreshEvent: function(props) {
        ...
        new DynaFaces.fireAjaxTransaction(
            ...
            render: props.id,
            replaceElement: webui.@THEME@.widget.jsfx.calendar.refreshCallback,
            xjson: {
                id: props.id,
                event: "refresh"
            }
    ...
    refreshCallback: function(id, content, closure, xjson) {
        ...
        dojo.event.topic.publish(
            webui.@THEME@.widget.calendar.refresh.endEventTopic, props);
        return true;
    }
}
...
dojo.event.topic.subscribe(webui.@THEME@.widget.calendar.refresh.beginEventTopic,
    webui.@THEME@.widget.jsfx.calendar, "processRefreshEvent");
