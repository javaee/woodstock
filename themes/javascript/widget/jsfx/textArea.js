 ...
 */
webui.@THEME@.widget.jsfx.textArea = {
    /**
    ...
    /**
     * This function is used to update widget after it has been submitted
     * and rendered back.
     * Note that client state of the textArea could have been changed
