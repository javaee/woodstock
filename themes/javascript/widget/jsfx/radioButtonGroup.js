 ...
 */
webui.@THEME@.widget.jsfx.radioButtonGroup = {
    /**
    ...
    processRefreshEvent: function(props) {
        ...
        DynaFaces.fireAjaxTransaction(
            ...
            render: props.id,
            replaceElement: webui.@THEME@.widget.jsfx.radioButtonGroup.refreshCallback,
            xjson: {
                id: props.id,
                event: "refresh"
            }
    ...
    refreshCallback: function(id, content, closure, xjson) {
        ...
        dojo.event.topic.publish(
            webui.@THEME@.widget.radioButtonGroup.refresh.endEventTopic, props);
        return true;
    }
}
...
dojo.event.topic.subscribe(webui.@THEME@.widget.radioButtonGroup.refresh.beginEventTopic,
    webui.@THEME@.widget.jsfx.radioButtonGroup, "processRefreshEvent");
