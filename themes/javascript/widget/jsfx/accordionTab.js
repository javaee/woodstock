...
webui.@THEME@.widget.jsfx.accordionTab = {
     ...
     * @param props Key-Value pairs of properties.
     */
    loadTabContentEvent: function(props) {
        if (props == null) {
            return false;
        }
    ...
    processRefreshEvent: function(props) {
        ...
        new DynaFaces.fireAjaxTransaction(
            ...
            render: props.id,
            replaceElement: webui.@THEME@.widget.jsfx.accordionTab.refreshCallback,
            xjson: {
                id: props.id,
                event: "refresh"
            }
    ...
    /**
     * This function is used to refresh a tabContent.
     *
    ...
    refreshCallback: function(id, content, closure, xjson) {
        ...
        dojo.event.topic.publish(webui.@THEME@.widget.accordionTab.refresh.endEventTopic, 
            json);
        return true;
    },
...
dojo.event.topic.subscribe(webui.@THEME@.widget.accordionTab.refresh.beginEventTopic,
    webui.@THEME@.widget.jsfx.accordionTab, "processRefreshEvent");
...
dojo.event.topic.subscribe(webui.@THEME@.widget.accordionTab.loadContent.beginEventTopic,
    webui.@THEME@.widget.jsfx.accordionTab, "loadTabContentEvent");
