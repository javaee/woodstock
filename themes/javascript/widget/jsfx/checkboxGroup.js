...
dojo.provide("webui.@THEME@.widget.jsfx.checkboxGroup");
 ...
 */
webui.@THEME@.widget.jsfx.checkboxGroup = {
    /**
    ...
    processRefreshEvent: function(props) {
        ...
        DynaFaces.fireAjaxTransaction(
            ...
            render: props.id,
            replaceElement: webui.@THEME@.widget.jsfx.checkboxGroup.refreshCallback,
            xjson: {
                id: props.id,
                event: "refresh"
            }
    ...
    refreshCallback: function(id, content, closure, xjson) {
        ...
        dojo.event.topic.publish(
            webui.@THEME@.widget.checkboxGroup.refresh.endEventTopic, props);
        return true;
    }
}
...
dojo.event.topic.subscribe(webui.@THEME@.widget.checkboxGroup.refresh.beginEventTopic,
    webui.@THEME@.widget.jsfx.checkboxGroup, "processRefreshEvent");
