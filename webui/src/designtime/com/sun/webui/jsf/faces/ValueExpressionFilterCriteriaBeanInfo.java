...
abstract class ValueExpressionFilterCriteriaBeanInfo extends SimpleBeanInfo {
    
    /**
     * The class of the component (bean) to which this BeanInfo corresponds.
     */
    protected Class beanClass = com.sun.webui.jsf.faces.ValueExpressionFilterCriteria.class;

    protected static ResourceBundle resourceBundle =
        ResourceBundle.getBundle("com.sun.webui.jsf.faces.BeanInfoBundle", Locale.getDefault(),ValueExpressionFilterCriteriaBeanInfo.class.getClassLoader());
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        if (beanDescriptor == null) {
            ...
            beanDescriptor.setDisplayName(resourceBundle.getString("ValueExpressionFilterCriteria_displayName"));
            beanDescriptor.setShortDescription(resourceBundle.getString("ValueExpressionFilterCriteria_shortDescription"));
    ...
    protected String iconFileName_C16 = "ValueExpressionFilterCriteria_C16";
    
    // The 32x32 color icon.
    private String iconFileName_C32 = "ValueExpressionFilterCriteria_C32";
    
    // The 16x16 monochrome icon.
    private String iconFileName_M16 = "ValueExpressionFilterCriteria_M16";
    
    // The 32x32 monochrome icon.
    private String iconFileName_M32 = "ValueExpressionFilterCriteria_C32";
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        if (propertyDescriptors == null) {
            try {
                ...
                propertyDescriptor.setDisplayName(resourceBundle.getString("ValueExpressionFilterCriteria_valueExpression_displayName"));
                propertyDescriptor.setShortDescription(resourceBundle.getString("ValueExpressionFilterCriteria_valueExpression_shortDescription"));
                ...
                propertyDescriptor.setDisplayName(resourceBundle.getString("ValueExpressionFilterCriteria_requestMapKey_displayName"));
                propertyDescriptor.setShortDescription(resourceBundle.getString("ValueExpressionFilterCriteria_requestMapKey_shortDescription"));
                ...
                propertyDescriptor.setDisplayName(resourceBundle.getString("ValueExpressionFilterCriteria_compareValue_displayName"));
                propertyDescriptor.setShortDescription(resourceBundle.getString("ValueExpressionFilterCriteria_compareValue_shortDescription"));
