...
abstract class ValueBindingSortCriteriaBeanInfo extends SimpleBeanInfo {
    
    /**
     * The class of the component (bean) to which this BeanInfo corresponds.
     */
    protected Class beanClass = com.sun.webui.jsf.faces.ValueBindingSortCriteria.class;

    protected static ResourceBundle resourceBundle =
        ResourceBundle.getBundle("com.sun.webui.jsf.faces.BeanInfoBundle", Locale.getDefault(),ValueBindingSortCriteriaBeanInfo.class.getClassLoader());
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        if (beanDescriptor == null) {
            ...
            beanDescriptor.setDisplayName(resourceBundle.getString("ValueBindingSortCriteria_displayName"));
            beanDescriptor.setShortDescription(resourceBundle.getString("ValueBindingSortCriteria_shortDescription"));
    ...
    protected String iconFileName_C16 = "ValueBindingSortCriteria_C16";
    
    // The 32x32 color icon.
    private String iconFileName_C32 = "ValueBindingSortCriteria_C32";
    
    // The 16x16 monochrome icon.
    private String iconFileName_M16 = "ValueBindingSortCriteria_M16";
    
    // The 32x32 monochrome icon.
    private String iconFileName_M32 = "ValueBindingSortCriteria_C32";
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        if (propertyDescriptors == null) {
            try {
                ...
                propertyDescriptor.setDisplayName(resourceBundle.getString("ValueBindingSortCriteria_valueExpression_displayName"));
                propertyDescriptor.setShortDescription(resourceBundle.getString("ValueBindingSortCriteria_valueExpression_shortDescription"));
                propertyDescriptorMap.put(propertyDescriptor.getName(), propertyDescriptor);

                propertyDescriptor =
                    new PropertyDescriptor("requestMapKey", this.beanClass, "getRequestMapKey", "setRequestMapKey");
                propertyDescriptor.setDisplayName(resourceBundle.getString("ValueBindingSortCriteria_requestMapKey_displayName"));
                propertyDescriptor.setShortDescription(resourceBundle.getString("ValueBindingSortCriteria_requestMapKey_shortDescription"));
