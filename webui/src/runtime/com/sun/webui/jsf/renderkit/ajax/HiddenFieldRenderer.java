...
@Renderer(@Renderer.Renders(
    rendererType="com.sun.webui.jsf.ajax.HiddenField",
    componentFamily="com.sun.webui.jsf.HiddenField"))
public class HiddenFieldRenderer 
        extends com.sun.webui.jsf.renderkit.widget.HiddenFieldRenderer {
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // Renderer methods
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    public void encodeChildren(FacesContext context, UIComponent component)
        ...
        if (ComponentUtilities.isAjaxRequest(context, component, "submit")) {            
            try {
                boolean valid = ((HiddenField) component).isValid();
