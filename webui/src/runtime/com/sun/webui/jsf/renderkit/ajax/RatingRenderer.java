...
/**
 * This class responds to Ajax requests made to Rating components.
 */
@Renderer(@Renderer.Renders(
    rendererType="com.sun.webui.jsf.ajax.Rating",
    componentFamily="com.sun.webui.jsf.Rating"))
public class RatingRenderer
        extends com.sun.webui.jsf.renderkit.widget.RatingRenderer {
	...
	Rating rating = (Rating) component;
        ...
        // Output component properties if Ajax request and is submit event.
        if (ComponentUtilities.isAjaxRequest(context, component, "submit")) {
	    try {
		JSONObject json = new JSONObject();
		json.put("id", rating.getClientId(context));
		json.put("averageGrade", rating.getAverageGrade());
