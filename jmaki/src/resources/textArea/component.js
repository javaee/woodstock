 ...
 *
 * This wrapper subscribes to the "/woodstock/textArea" jMaki event.
 ...
 * included in the page containing this textArea wrapper widget.
 */
@JMAKI_NS@.textArea.Widget = function(wargs) {
    ...
    var self = this;
    var refreshTopic = "/@JS_NAME@/textArea/refresh";
    var publishTopic;
    var id = wargs.id;
...
//    jmaki.subscribe(refreshTopic, refreshHandler);
    ...
    // Refresh event handler for jMaki wrapper of Woodstock textArea.
    //
