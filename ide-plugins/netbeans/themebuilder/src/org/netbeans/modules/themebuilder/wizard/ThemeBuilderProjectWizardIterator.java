...
public final class ThemeBuilderProjectWizardIterator implements WizardDescriptor.InstantiatingIterator {
    ...
    public Set<FileObject> instantiate() throws IOException {
        ...
        unZipFile(themeDataUrl.openStream(), projectRootDir, null);
        
        cloneTheme(projectRootDir);
    ...
    private File getAntScript(File projectRootDir) {     
        return new File(projectRootDir, "build.xml");
    }
    
    private boolean cloneTheme(File projectRootDir) {
        try {
            
            ExecutorTask executorTask = ActionUtils.runTarget(FileUtil.toFileObject(getAntScript(projectRootDir)),
                    new String[] {"clone-theme"}, null);
        ...
        try {
            ...
            while ((zipEntry = zipInputStream.getNextEntry()) != null) {
                ...
                if (zipEntry.isDirectory()) {
                    ...
                    try {
                        if (sourceFilePattern.matcher(entryName).matches() && (paramMap != null)) {
                            String line;
